...
module @test attributes { dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi64>>>} {
  reussir.func @record_coerce_first_variant(%variant_ref : !reussir.ref<!variant_record>) -> !reussir.ref<i32> {
  ...
  reussir.func @record_coerce_second_variant(%variant_ref : !reussir.ref<!variant_record>) -> !reussir.ref<i64> {
    // CHECK: %[[GEP:.*]] = getelementptr %test_variant, ptr %0, i32 0, i32 1
    // CHECK: ret ptr %[[GEP]]
  ...
  reussir.func @record_coerce_third_variant(%variant_ref : !reussir.ref<!variant_record>) -> !reussir.ref<f32> {
    // CHECK: %[[GEP:.*]] = getelementptr %test_variant, ptr %0, i32 0, i32 1
    // CHECK: ret ptr %[[GEP]]
  ...
  reussir.func @record_coerce_with_capabilities(%variant_ref : !reussir.ref<!variant_record shared>) -> !reussir.ref<i32 shared> {
    // CHECK: %[[GEP:.*]] = getelementptr %test_variant, ptr %0, i32 0, i32 1
    // CHECK: ret ptr %[[GEP]]
