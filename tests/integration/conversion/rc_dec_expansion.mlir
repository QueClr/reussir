...
// CHECK-DAG: reussir.func private @_RINvNvC4core9intrinsic13drop_in_placeListE
...
// CHECK-DAG: reussir.call @_RINvNvC4core9intrinsic13drop_in_placeListE

// CHECK-DAG: reussir.func @test_rc_dec_expansion
...
module attributes { dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi64>>, #dlti.dl_entry<i8, dense<8> : vector<2xi64>>> }  {
  reussir.func @test_rc_dec_expansion(%arg0: !reussir.rc<!list>) {
