...
module {
  // CHECK: reussir.func @drop_basic(%arg0: !reussir.ref<i32>)
  reussir.func @drop_basic(%ref : !reussir.ref<i32>) {
    // CHECK: reussir.ref.drop(%arg0 : !reussir.ref<i32>)
    reussir.ref.drop (%ref : !reussir.ref<i32>)
    return
  }

  reussir.func @drop_rc(%ref : !reussir.ref<!reussir.rc<i64>>) {
    // CHECK: reussir.ref.drop(%arg0 : !reussir.ref<!reussir.rc<i64>>)
    reussir.ref.drop (%ref : !reussir.ref<!reussir.rc<i64>>)
    return
  }

  reussir.func @drop_compound(%ref : !reussir.ref<!test>) {
    reussir.ref.drop (%ref : !reussir.ref<!test>)
    return
  }
  reussir.func @drop_variant(%ref : !reussir.ref<!inner>) {
    reussir.ref.drop (%ref : !reussir.ref<!inner>)
    return
  }
  reussir.func @drop_tree(%ref : !reussir.ref<!tree>) {
