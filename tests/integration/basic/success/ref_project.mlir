...
module {
  ...
  reussir.func @project_simple(%ref : !reussir.ref<!point>) -> !reussir.ref<i32> {
  ...
  reussir.func @project_rigid(%ref : !reussir.ref<!point rigid>) -> !reussir.ref<i32 rigid> {
  ...
  reussir.func @project_shared(%ref : !reussir.ref<!point shared>) -> !reussir.ref<i32 shared> {
  ...
  reussir.func @project_complex(%ref : !reussir.ref<!complex rigid>) -> 
